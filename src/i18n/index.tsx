...
const TRANSLATIONS = {
  de: {
    ...
    streetViewLink: "Google Street View öffnen",
    measureClear:   "Messung löschen",
    sectionClear:   "Abschnitt löschen",
    mapillaryLabel: "Straßenansicht (Mapillary)",
    fitMap: "Einpassen",
    clearMap: "Löschen",
  ...
  en: {
    ...
    streetViewLink: "Open Google Street View",
    measureClear:   "Clear measurement",
    sectionClear:   "Clear section",
    mapillaryLabel: "Street imagery (Mapillary)",
    fitMap: "Fit",
    clearMap: "Clear",
