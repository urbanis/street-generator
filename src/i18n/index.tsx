...
const TRANSLATIONS = {
  de: {
    ...
    streetSubtitle: "Untertitel",
    streetSubtitlePlaceholder: "z. B. Prenzlauer Berg, Berlin",
    ...
    colorFill:           "Füllung",
    colorStroke:         "Kontur",
    customLabel:         "Benutzerdefinierter Name",
    template:            "Vorlage",
    ...
    themeLabels:         "Labels",
    themeMeasures:       "Maße",
    generateStreet:      "Straße generieren",
  ...
  en: {
    ...
    streetSubtitle: "Subtitle",
    streetSubtitlePlaceholder: "e.g. Prenzlauer Berg, Berlin",
    ...
    themeColor:          "Color",
    themeLabels:         "Labels",
    themeMeasures:       "Measures",
    generateStreet:      "Generate street",
    exportLabel:         "Export",
    copied:              "Copied!",
  },
} as const;
