...
const TRANSLATIONS = {
  de: {
    ...
    floorUseGewerbe:   "Gewerbe",
    floorUseGemischt:  "Gemischt",
    floorUseOffentlich:"Öffentlich",
    ...
    themeOutlineLabel:       "Umriss + Labels",
    themeOutlineLabelMeasure:"Umriss + Labels + Maße",
    themeOutlineMeasure:     "Umriss + Maße",
    // Map / Explore
    ...
    mapModeMarkSection: "Abschnitt generieren",
    mapModeMeasure: "Messen",
    mapModeInspect: "Inspizieren",
    inspectNoData:  "Keine OSM-Daten an diesem Punkt",
    inspectTags:    "Alle Tags anzeigen",
    inspectTagsHide:"Tags ausblenden",
    streetViewLink: "Google Street View",
    measureClear:   "Messung löschen",
    sectionClear:   "Abschnitt löschen",
    mapillaryLabel: "Straßenansicht",
    fitMap: "Einpassen",
    clearMap: "Löschen",
  ...
  en: {
    ...
    floorUseWohnen:    "Residential",
    floorUseGewerbe:   "Commercial",
    floorUseGemischt:  "Mixed",
    floorUseOffentlich:"Public",
    addFloor:          "Add floor",
    floors:            "Floors",
    LEFT: "Left",
    CENTER: "Center",
    ...
    themeOutlineLabel:       "Outline + labels",
    themeOutlineLabelMeasure:"Outline + labels + measurements",
    ...
    toolsLabel: "Tools",
    mapModeMarkSection: "Generate section",
    mapModeMeasure: "Measure",
    mapModeInspect: "Inspect",
    inspectNoData:  "No OSM data at this point",
    inspectTags:    "Show all tags",
    inspectTagsHide:"Hide tags",
    streetViewLink: "Google Street View",
    measureClear:   "Clear measurement",
    sectionClear:   "Clear section",
    mapillaryLabel: "Street imagery",
    fitMap: "Fit",
    clearMap: "Clear",
